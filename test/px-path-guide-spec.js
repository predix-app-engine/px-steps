...
describe('Instancing component from provided DOM data attribute', function () {
    ...
    before(function() {
        ...
        return driver.wait(webdriver.until.elementLocated(webdriver.By.css("px-path-guide")), 3000);
    });

    it('should instance a px-path-guide from the expected DOM', function () {
        return chai.expect(
            driver.findElement(webdriver.By.css("px-path-guide"))
        ).to.eventually.exist;
    });

    it('should have default steps', function () {
        return chai.expect(
            driver.findElements(webdriver.By.css("px-path-guide div.step-icon"))
...
describe('Interaction', function () {
    ...
    it('should emit an event when a step is clicked', function () {
        driver.findElement(webdriver.By.css("px-path-guide div.step-connector")).click();
